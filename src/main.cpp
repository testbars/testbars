...
uint256 hashGenesisBlock("0x879e549045ad7385419505929bc34c2316ee8f9c50078f183309bce14ba3818d");
...
const string strMessageMagic = "TestBars Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 1 * 60 * 60; // TestBars: 1 hour
static const int64 nTargetSpacing = 60; // TestBars: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal testbars miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TestBars", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x03d8d1516f49d2060d931abf16be08607c398c345d73466fca66d4c1ea688866");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2/11/2015 0240 hrs";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1423974778; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 18891;

        if (fTestNet)
        {
            block.nTime    = 1423640300;
            block.nNonce   = 2195909;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x4c58a9d6318fae6df7b036d6a85ad5434583a27d837b91a6d9574ba180891154"));
